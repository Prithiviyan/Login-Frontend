...
const Login = () => {
  ...
  return (
    <div className="md:w-[500px] mx-auto shadow-md rounded-xl shadow-gray-700 my-1">
      ...
      <div className="p-4 grid grid-cols-1 gap-3 ">
        ...
        {passError && (
          <span className="text-red-500 font-bold text-lg">{passError}</span>
        )}
        ...
        <div className="flex justify-center items-center text-lg">
          Don't have an account? <Link to={"/"} className="ml-3 text-xl text-blue-700">Register</Link>
        </div>
      </div>
    </div>
  );
