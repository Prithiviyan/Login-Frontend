...
const Register = () => {
  ...
  return (
    <section className=" flex h-[900px] lg:h-[710px] my-4 " >
      <div className="flex  flex-col md:w-[500px] mx-auto shadow-md rounded-xl shadow-gray-700 py-2 ">
        ...
        <form>
          ...
          <div className="flex justify-center items-center text-lg py-2">
            ...
            <Link to={"/login"} className="ml-3 text-xl text-blue-700">
              Login
            </Link>
          </div>
        </form>
